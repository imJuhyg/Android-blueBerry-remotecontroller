...
import com.limjuhyg.blueberry.databinding.ActivityWidgetContainerBinding
...
class WidgetContainerActivity : AppCompatActivity() {
    private lateinit var binding: ActivityWidgetContainerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWidgetContainerBinding.inflate(layoutInflater)
