...
import com.totheptv.blueberry.recyclerviews.items.ChatRecyclerViewItem
import java.text.SimpleDateFormat
import java.util.*
import kotlin.collections.ArrayList

class ChatRecyclerViewAdapter : RecyclerView.Adapter<ChatRecyclerViewAdapter.ViewHolder>() {
    private val chatRecyclerViewItems by lazy { ArrayList<ChatRecyclerViewItem>() }
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        val item = chatRecyclerViewItems[position]
